...
uint8_t Fu8__make_arp_poisoning(struct cstc_malcolm_data *ptr_cstc_pssd_malcolm_data)
    ...
    */
    ...
    ft_printf("Receve an ARP request from %u.%u.%u.%u to %u.%u.%u.%u\n", ptr_cstc_pssd_malcolm_data->u8_source_ip_addr_[0], ptr_cstc_pssd_malcolm_data->u8_source_ip_addr_[1], ptr_cstc_pssd_malcolm_data->u8_source_ip_addr_[2], ptr_cstc_pssd_malcolm_data->u8_source_ip_addr_[3], ptr_cstc_pssd_malcolm_data->u8_target_ip_addr_[0], ptr_cstc_pssd_malcolm_data->u8_target_ip_addr_[1], ptr_cstc_pssd_malcolm_data->u8_target_ip_addr_[2], ptr_cstc_pssd_malcolm_data->u8_target_ip_addr_[3]);
