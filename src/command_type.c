...
uint8_t Fu8__is_hash_type(struct sstc_argument *ptr_sstc_pssd_argument, uint8_t *ptr_u8_pssd_command_name, uint8_t *ptr_u8_pssd_answer_to_set)
    {
    /**
...
uint8_t Fu8__is_base64_type(struct sstc_argument *ptr_sstc_pssd_argument, uint8_t *ptr_u8_pssd_command_name, uint8_t *ptr_u8_pssd_answer_to_set)
    {
    /**
    * Assertion of argument
    */
...
uint8_t Fu8__is_des_type(struct sstc_argument *ptr_sstc_pssd_argument, uint8_t *ptr_u8_pssd_command_name, uint8_t *ptr_u8_pssd_answer_to_set)
    {
    /**
    * Assertion of argument
    */
...
uint8_t Fu8__is_des3_type(struct sstc_argument *ptr_sstc_pssd_argument, uint8_t *ptr_u8_pssd_command_name, uint8_t *ptr_u8_pssd_answer_to_set)
    {
    /**
    * Assertion of argument
    */
...
* argc = (argc - 1)
*/
uint8_t Fu8__find_command_type(struct sstc_argument *ptr_sstc_pssd_argument, int32_t s32_pssd_program_argument_number, uint8_t **dbl_ptr_u8_pssd_program_arguments)
    {
    /**
    * Assertion of argument
    */
    ...
    */
    if(u8_lcl_answer == ANSWER_POSITIVE)
        ...
        */
        u8_lcl_return_from_function = RETURN_FAILURE;
        u8_lcl_return_from_function = Fu8__preset_structure_struct sstc_argumento_hash_setting(ptr_sstc_pssd_argument);
    ...
    */
    if(u8_lcl_answer == ANSWER_POSITIVE)
        ...
        */
        u8_lcl_return_from_function = RETURN_FAILURE;
        u8_lcl_return_from_function = Fu8__preset_structure_struct sstc_argumento_base64_setting(ptr_sstc_pssd_argument);
    ...
    */
    if(u8_lcl_answer == ANSWER_POSITIVE)
        ...
        */
        u8_lcl_return_from_function = RETURN_FAILURE;
        u8_lcl_return_from_function = Fu8__preset_structure_struct sstc_argumento_des_setting(ptr_sstc_pssd_argument);
    ...
    */
    if(u8_lcl_answer == ANSWER_POSITIVE)
        ...
        */
        u8_lcl_return_from_function = RETURN_FAILURE;
        u8_lcl_return_from_function = Fu8__preset_structure_struct sstc_argumento_des3_setting(ptr_sstc_pssd_argument);
